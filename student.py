...
class Student:
    def __init__(self, root):
      ...
      # First image
        img = Image.open(r"C:\Users\theph\OneDrive\Desktop\MajorProject\Facial Recognition System\college_images\face-recognition.png")
        img = img.resize((500, 130), Image.LANCZOS) # Change this line
        ...
        # Second image
        img1 = Image.open(r"C:\Users\theph\OneDrive\Desktop\MajorProject\Facial Recognition System\college_images\smart-attendance.jpg")
        ...
        #Third image
        img2 = Image.open(r"C:\Users\theph\OneDrive\Desktop\MajorProject\Facial Recognition System\college_images\atten.jpg")
        ...
        #bg image
        img3 = Image.open(r"C:\Users\theph\OneDrive\Desktop\MajorProject\Facial Recognition System\college_images\wp9287552-intelligent-4k-wallpapers.jpg")
        ...
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT  ",font=("times new roman",35,"bold"),bg="white",fg="blue")
        ...
        img_left= Image.open(r"C:\Users\theph\OneDrive\Desktop\MajorProject\Facial Recognition System\college_images\AdobeStock_303989091.jpeg")
        ...
        #current course info
        current_course_frame=LabelFrame(Left_frame,bd=2,relief=RIDGE,text="Current cource Information",font=("times new roman",12,"bold"))
        ...
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("time new roman",12,"bold"),state="read only")
        ...
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,font=("time new roman",12,"bold"),state="read only")
        ...
        semester_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("time new roman",12,"bold"),state="read only")
        ...
        #Gender
        gender_div_label=Label(class_Student_frame,text="Gender:",font=("time new roman",12,"bold"),bg="white")
        gender_div_label.grid(row=2,column=0,padx=10,sticky=W)
        ...
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=17,font=("time new roman",13,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3)
        
        btn_frame1=Frame(class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=235,width=715,height=35)
        
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=35,font=("time new roman",13,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0)
        
        update_photo_btn=Button(btn_frame1,text="UpdatePhotoSample",width=35,font=("time new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right= Image.open(r"C:\Users\theph\OneDrive\Desktop\MajorProject\Facial Recognition System\college_images\student.jpg")
    ...
    # ===================Search System==================
        ...
        search_label=Label(Search_frame,bd=2,bg="red",relief=RIDGE,text="Search By:",font=("times new roman",15,"bold"),fg="white")
    ...
    def add_data(self):
      if self.var_dep.get()=="Select Department" or self.var_std_name.get()==" " or self.var_std_id.get()=="":
       messagebox.showerror("Error","All fields are required",parent=self.root)
          ...
          try:
              conn=mysql.connector.connect(host="localhost",username="root",password="AryanMishra1079",database="face_recognizer")
    ...
    def delete_data(self):
      if self.var_std_id.get()=="":
         messagebox.showerror("Error,Student Id must be required",parent=self.root)
          ...
          try:
              delete=messagebox.askyesno("Studnet Delete Page","Do you want to delete this student",parent=self.root)
              if delete>0:  
                 conn=mysql.connector.connect(host="localhost",username="root",password="AryanMishra1079",database="face_recognizer")
                 my_cursor=conn.cursor() 
           ...
           messagebox.showerror("Error","All fields are required",parent=self.root)
             ...
             try:
               ...
               #=========================Loading Predefined data on face frontals from opencv=================#
                ...
                face_classifier =cv2.CascadeClassifier(r"C:\Users\theph\OneDrive\Desktop\MajorProject\Facial Recognition System\haarcascade_frontalface_default.xml")
