...
class Attendance:
    def __init__(self, root):
        ...
        f_lbl.place(x=0, y=0, width=800, height=200)
         ...
         #second image
        img1= Image.open(r"college_images\atten.jpg")
        ...
        #bg image
        img3 = Image.open(r"college_images\wp9287552-intelligent-4k-wallpapers.jpg")
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT  ",font=("times new roman",35,"bold"),bg="white",fg="blue")
        ...
        rollLabel.grid(row=0,column=2,padx=3,pady=8) 
        ...
        save_btn=Button(btn_frame,text="Import csv",command=self.importCsv,width=17,font=("time new roman",13,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)
        
        update_btn=Button(btn_frame,text="Export csv",command=self.exportCsv,width=17,font=("time new roman",13,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)
        
        delete_btn=Button(btn_frame,text="Update",width=17,font=("time new roman",13,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)
        
        reset_btn=Button(btn_frame,text="Reset",width=17,command=self.reset_data,font=("time new roman",13,"bold"),bg="blue",fg="white")
